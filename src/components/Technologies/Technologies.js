...
return(
  <Section id="tech">
    ...
    <List>
      <ListItem>
        <ListContainer>
          <ListTitle data-aos="fade-left" data-aos-duration="900">Front-end</ListTitle>
      ...
      <ListItem>
        <ListContainer>
          ...
          <ListParagraph data-aos="fade-down" data-aos-duration="1000">
            Experience with <br /> 
      ...
      <ListItem>
        <ListContainer>
          <ListTitle data-aos="fade-right" data-aos-duration="900">Tools</ListTitle>
